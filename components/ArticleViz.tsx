  ...
  "직장가입자-자격변동-상실-신고": {
    "after-0": (
      <ComparisonTable
        ...
        headers={["구분", "자격변동", "자격상실"]}
        rows={[
          ["의미", "사업장 간 이동(전출입)", "직장가입자 자격 자체를 잃음"],
          ["사유", "전근·이직·사업장 변경", "퇴직·사망·국적상실·의료급여 수급"],
          ["신고 기한", "변동일부터 14일 이내", "상실일부터 14일 이내"],
          ["신고 의무자", "변동된 사업장의 사용자", "상실 전 사업장의 사용자"],
        ]}
      />
    ),
    "after-2": (
  ...
  "요양급여-비급여-범위-요양기관": {
    "after-0": (
      <ComparisonTable
        ...
        headers={["구분", "요양급여", "비급여"]}
        rows={[
          ["보험 적용", "건강보험 적용 (공단 부담)", "전액 본인 부담"],
          ["대상", "진찰·검사·약제·수술·입원 등", "업무·일상생활에 지장 없는 질환, 미용 목적 등"],
          ["예시", "감기 진료, 수술, 입원 치료", "쌍꺼풀 수술, 치아미백, 건강증진 목적 예방접종 등"],
          ["법적 근거", "국민건강보험법 제41조", "국민건강보험법 제41조제4항"],
        ]}
      />
    ),
    "after-2": (
  ...
  "건강보험-건강검진-종류-대상-비용": {
    "after-0": (
      <ComparisonTable
        ...
        headers={["검진 종류", "대상", "주기"]}
        rows={[
          ["일반건강검진", "직장가입자, 세대주, 40세 이상 지역가입자·피부양자", "2년에 1회 (비사무직 매년)"],
          ["암검진", "위암(40세↑), 간암(40세↑), 대장암(50세↑), 유방암(40세↑ 여성), 자궁경부암(20세↑ 여성), 폐암(54~74세 고위험자)", "종류별 상이"],
          ["영유아건강검진", "생후 14일~72개월 영유아", "월령별 검진 시기"],
        ]}
      />
    ),
    "after-2": (
  ...
  "건강보험급여-제한-지급정지-사유": {
    "after-0": (
      <ComparisonTable
        ...
        headers={["구분", "급여 제한", "지급 정지"]}
        rows={[
          ["의미", "보험급여를 하지 않음", "일정 기간 급여를 중단"],
          ["사유", "고의·중과실, 보험료 체납", "국외 체류, 현역병, 교도소 수용"],
          ["해제 조건", "체납보험료 완납 등", "사유 소멸 시 자동 해제"],
          ["예외", "체납 6회 미만이면 제한 안 됨", "현역병·수용자는 요양급여 실시"],
        ]}
      />
    ),
    "after-2": (
  ...
  "건강보험료-경감-면제-사유-경감률": {
    "after-0": (
      <ComparisonTable
        ...
        headers={["사유", "경감 대상", "경감률"]}
        rows={[
          ["섬·벽지 거주", "등록 세대원", "50%"],
          ["휴직 (무보수)", "휴직 근로자", "50% (납부유예 가능)"],
          ["육아휴직", "육아휴직자", "60%"],
          ["현역병 등 복무", "복무 중인 가입자", "면제"],
          ["국외 체류", "1개월 이상 국외 체류자", "면제 (신청 시)"],
        ]}
      />
    ),
    "after-2": (
  ...
  "건강보험료-납부-정산-부담-방법": {
    "after-0": (
      <ComparisonTable
        ...
        headers={["가입자 유형", "가입자 부담", "사용자 부담", "국가 부담"]}
        rows={[
          ["일반 근로자", "50%", "50%", "-"],
          ["공무원", "50%", "50% (국가·지자체)", "-"],
          ["사립학교 교직원 (교원 외)", "50%", "50% (설립자)", "-"],
          ["사립학교 교원", "50%", "30% (설립자)", "20%"],
        ]}
      />
    ),
    "after-2": (
  ...
  "건강보험료-체납-연체금-독촉-처분": {
    "after-0": (
      <ComparisonTable
        ...
        headers={["구분", "1단계", "2단계"]}
        rows={[
          ["적용 시점", "납부기한 다음 날부터", "독촉장 납부기한 다음 날부터"],
          ["부과 방식", "체납보험료의 일정 비율", "체납보험료의 추가 비율"],
          ["최대 한도", "체납보험료의 5%", "매 1일마다 일정액 (총 9% 한도)"],
        ]}
      />
    ),
    "after-2": (
