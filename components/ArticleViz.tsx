...
const VIZ_MAP: VizMap = {
  "협의이혼-절차-서류-이혼숙려기간": {
    top: (
      <StatCard
        items={[
          { value: "1개월", label: "숙려기간", sub: "미성년 자녀 없음" },
          { value: "3개월", label: "숙려기간", sub: "미성년 자녀 있음" },
          { value: "3개월", label: "이혼신고 기한", sub: "확인서등본 발급 후" },
          { value: "0원", label: "법원 수수료", sub: "협의이혼 무료" },
        ]}
      />
    ),
    "after-0": (
    ...
    "after-2": (
      <ProcessTimeline
        steps={[
          { step: "1", title: "신청서 + 서류 제출", desc: "관할 가정법원에 이혼신청서와 구비서류를 접수해요." },
          { step: "2", title: "이혼안내 상담", desc: "법원에서 이혼의 법적 효과, 양육·재산 문제를 안내받아요." },
          { step: "3", title: "숙려기간", desc: "자녀 없으면 1개월, 있으면 3개월 동안 냉각 기간을 가져요." },
          { step: "4", title: "판사 앞 이혼의사 확인", desc: "부부 본인이 직접 출석해서 판사에게 이혼 의사를 확인받아요." },
          { step: "5", title: "확인서등본 발급", desc: "이혼의사확인서등본이 발급돼요." },
          { step: "6", title: "구청에 이혼신고", desc: "확인서등본 발급 후 3개월 이내에 이혼신고를 해야 해요." },
        ]}
      />
    ),
    "after-3": (
