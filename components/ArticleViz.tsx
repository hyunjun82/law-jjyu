...
const VIZ_MAP: VizMap = {
  ...
  "산업재해보상보험-개념-특징-적용범위": {
    "after-0": (
      <ComparisonTable
        title="산재보험 vs 민간 상해보험 비교"
        columns={[
          { name: "산재보험", highlight: true },
          { name: "민간 상해보험" },
        ]}
        rows={[
          { label: "가입 의무", values: ["사업주 의무 가입", "개인 선택 가입"] },
          { label: "보험료 부담", values: ["사업주 전액 부담", "가입자 본인 부담"] },
          { label: "과실 여부", values: ["근로자 과실 있어도 보상", "약관에 따라 제한"] },
          { label: "보상 수준", values: ["실비 + 소득 보전", "약관 한도 내 정액"] },
          { label: "근거 법률", values: ["산업재해보상보험법", "상법·보험업법"] },
        ]}
      />
    ),
    "after-2": (
      <WarningBox
        ...
        title="산재보험 적용 제외 사업"
      >
        <p>공무원·군인·선원·사립학교 교직원 등 다른 법으로 재해보상을 받는 사업, 상시근로자 5명 미만의 농업·임업·어업·수렵업 중 법인이 아닌 사업은 산재보험이 적용되지 않아요.</p>
      </WarningBox>
    ),
  },

  // ── 근로노동: Article 2 ──
  "산재보험-보험급여-종류-요양급여-휴업급여": {
    "after-0": (
      <StatCard
        items={[
          { label: "보험급여 종류", value: "8가지", sub: "요양·휴업·장해·간병·유족·상병보상연금·장례비·직업재활" },
          { label: "요양급여 기준", value: "3일 초과", sub: "치유에 3일 넘게 걸리는 경우" },
          { label: "휴업급여 금액", value: "평균임금 70%", sub: "취업하지 못한 기간" },
        ]}
      />
    ),
    "after-2": (
      <ComparisonTable
        ...
        rows={[
          { label: "요양급여", values: ["치료비 보전", "요양 기간 중"] },
          { label: "휴업급여", values: ["소득 보전", "취업 불능 기간 중"] },
          { label: "장해급여", values: ["장해 보상", "요양 종결 후 장해 잔존 시"] },
          { label: "유족급여", values: ["사망 보상", "근로자 사망 시"] },
          { label: "상병보상연금", values: ["장기 요양 보전", "2년 이상 요양 + 1~3급"] },
        ]}
      />
    ),
  },
  ...
  // ── 근로노동: Article 3 ──
  "산재보험-요양급여-지급요건-범위-산정기준": {
    "after-0": (
      <EligibilityChecker
        questions={[
          { question: "업무상 재해(사고·질병)로 인정되었나요?", helpText: "근로복지공단의 업무상 재해 인정 필요" },
          { question: "치유에 3일을 초과하는 요양이 필요한가요?", helpText: "3일 이내 치유 가능하면 요양급여 대상 아님" },
          { question: "산재보험 의료기관에서 요양하고 있나요?", helpText: "산재보험 의료기관 또는 공단 승인 비지정 의료기관" },
        ]}
        passMessage="요양급여 지급 요건을 충족해요"
        failMessage="일부 요건이 충족되지 않아 확인이 필요해요"
      />
    ),
    "after-1": (
      <AccordionChecklist
        groups={[
          {
            title: "기본 요양급여 범위 7가지",
            items: [
              "진찰·검사",
              "약제·진료재료·의지(義肢) 등 보조기 지급",
              "처치·수술 등의 치료",
              "재활치료",
              "입원",
              "간호·간병",
    ...
    "after-2": (
      <WarningBox
        ...
        title="요양급여 7가지 범위"
      >
        <p>진찰·검사, 약제·진료재료·의지 등 보조기, 처치·수술 등의 치료, 재활치료, 입원, 간호·간병, 이송이 요양급여의 범위에 포함돼요. 치과보철, 재활보조기구, 한방 첩약 등 추가 항목도 인정될 수 있어요.</p>
      </WarningBox>
    ),
    "after-3": (
      <ContactCard
        contacts={[
          {
            name: "근로복지공단",
            description: "산재보험 요양급여 신청·문의·비지급 확인",
            phone: "1588-0075",
            url: "https://comwel.or.kr",
            urlLabel: "comwel.or.kr",
            hours: "평일 09:00~18:00",
          },
        ]}
      />
  ...
  "산재보험-요양급여-신청-절차-소멸시효": {
    "after-0": (
      <ProcessTimeline
        steps={[
          { step: "1", title: "요양급여 신청서 제출", desc: "근로복지공단 또는 산재보험 의료기관에 신청서·소견서 제출" },
          { step: "2", title: "사업주 의견 제출", desc: "공단이 사업주에게 통보, 사업주는 10일 이내 의견 제출 가능" },
          { step: "3", title: "지급 결정", desc: "신청일로부터 7일 이내 결정 (심의·조사 기간 제외)" },
          { step: "4", title: "요양급여 지급", desc: "결정 후 산재보험 의료기관에서 치료 시작" },
        ]}
      />
    ),
    "after-2": (
      <DateCalculator
        title="요양급여 소멸시효 계산"
        presets={[
          { label: "소멸시효 3년", days: 1095, description: "요양을 받은 날의 다음 날부터 3년" },
        ]}
        description="요양급여 청구권은 요양을 받은 날의 다음 날부터 3년 이내에 행사해야 해요."
      />
    ),
  },
  ...
  "산재-요양기간-연장-의료기관-변경-절차": {
    "after-0": (
      <StatCard
        items={[
          { label: "일반 연장 단위", value: "3개월", sub: "주치의 소견서 첨부" },
          { label: "장기 질병 연장 단위", value: "1년", sub: "진폐·이황화탄소 중독 등" },
          { label: "병행진료 허용 사유", value: "13가지", sub: "진료과 부재·검사 필요 등" },
        ]}
      />
    ),
    "after-2": (
      <WarningBox
        type="warning"
        title="의료기관 변경 전 반드시 승인받으세요"
      >
        <p>의료기관을 변경하려면 전원요양신청서를 먼저 근로복지공단에 제출해서 승인받아야 해요. 승인 없이 옮기면 요양급여가 지급되지 않을 수 있어요.</p>
      </WarningBox>
    ),
  },
  ...
  "산재-추가상병-요양급여-재요양-신청-요건": {
    "after-0": (
      <ComparisonTable
        title="추가상병 vs 재요양 비교"
        columns={[
          { name: "추가상병" },
          { name: "재요양" },
        ]}
        rows={[
          { label: "시점", values: ["요양 중 새 부상·질병 발견", "요양 종결 후 재발·악화"] },
          { label: "요건", values: ["최초 업무상 재해와 상당인과관계", "상당인과관계 + 치료 효과 기대"] },
          { label: "신청서", values: ["추가상병신청서", "재요양신청서"] },
          { label: "결정 기한", values: ["7일 이내", "7일 이내"] },
        ]}
      />
    ),
    "after-2": (
      <WarningBox
        type="info"
        title="재요양 3가지 요건을 모두 충족해야 해요"
      >
        <p>최초 업무상 재해와 상당인과관계가 있고, 나이·업무 외 원인이 아니어야 하며, 적극적인 치료 효과가 기대되어야 재요양이 승인돼요.</p>
      </WarningBox>
    ),
  },
  ...
  "산재보험-요양비-간병료-이송비-지급기준": {
    "after-1": (
      <RangeTable
        ...
        rows={[
          { range: "1등급", values: ["79,590원", "69,370원"], highlight: true },
          { range: "2등급", values: ["66,320원", "57,810원"] },
          { range: "3등급", values: ["53,060원", "46,250원"] },
        ]}
      />
    ),
    "after-2": (
      <StatCard
        items={[
          { label: "간병료 소멸시효", value: "3년" },
          { label: "동시 2명 이상 간병", value: "20% 가산" },
          { label: "이송비 지급 기준", value: "실비 지급", sub: "통원치료 교통비 포함" },
        ]}
      />
    ),
  },
  ...
  "산재-요양급여-본인부담금-대부-융자-조건": {
    "after-0": (
      <StatCard
        items={[
          { label: "대부 발생 요건", value: "결정 30일 초과 지연" },
          { label: "대부 금액 범위", value: "50만~1,000만원" },
          { label: "총 상환 기간", value: "최대 5년", sub: "거치 2년 + 상환 3년" },
        ]}
      />
    ),
    "after-2": (
      <RangeTable
        ...
        rows={[
          { range: "거치기간", values: ["2년", "0.6%"] },
          { range: "상환기간", values: ["3년", "2.6%"] },
        ]}
      />
    ),
  },
  ...
  "산재-휴업급여-지급요건-금액-청구절차": {
    "after-0": (
      <StatCard
        items={[
          { label: "지급 요건", value: "3일 초과 요양", sub: "취업하지 못한 기간" },
          { label: "1일 지급액", value: "평균임금 70%" },
          { label: "지급 결정 기한", value: "14일 이내" },
          { label: "소멸시효", value: "3년", sub: "휴업한 날의 다음 날부터" },
        ]}
      />
    ),
    "after-2": (
      <DateCalculator
        title="휴업급여 소멸시효 계산"
        presets={[
          { label: "소멸시효 3년", days: 1095, description: "휴업한 날의 다음 날부터 3년" },
        ]}
        description="휴업급여 청구권은 휴업한 날의 다음 날부터 3년 이내에 행사해야 해요."
      />
    ),
  },
  ...
  "산재-부분휴업급여-저소득-고령자-재요양-특례": {
    "after-0": (
      <ComparisonTable
        ...
        rows={[
          { label: "계산 공식", values: ["(평균임금 − 실제임금) × 90%"] },
          { label: "계산 예시", values: ["평균임금 10만원, 4시간 근무 36,000원 수령 → 부분휴업 12,600원 + 미취업분 35,000원 = 47,600원"] },
          { label: "필요 서류", values: ["부분휴업급여청구서 + 부분취업내역신고서"] },
          { label: "신청처", values: ["근로복지공단 (☎ 1588-0075, total.comwel.or.kr)"] },
        ]}
      />
    ),
    "after-1": (
  ...
  "산재-상병보상연금-지급요건-금액-청구": {
    "after-0": (
      <EligibilityChecker
        questions={[
          { question: "요양 시작 후 2년이 경과했나요?", helpText: "요양 시작일로부터 2년이 지나야 해요" },
          { question: "중증요양상태등급 1~3급에 해당하나요?", helpText: "근로복지공단의 등급 판정 필요" },
          { question: "요양 중 취업하지 못하고 있나요?", helpText: "취업 불능 상태여야 해요" },
        ]}
        passMessage="상병보상연금 지급 요건을 충족해요"
        failMessage="일부 요건이 충족되지 않아 확인이 필요해요"
      />
    ),
    "after-1": (
      <RangeTable
        ...
        rows={[
          { range: "1급", values: ["평균임금 329일분"], highlight: true },
          { range: "2급", values: ["평균임금 291일분"] },
          { range: "3급", values: ["평균임금 257일분"] },
        ]}
      />
    ),
  },
  ...
  "산재-상병보상연금-저소득-고령자-재요양-중증요양상태등급": {
    "after-0": (
      <StatCard
        items={[
          { label: "저소득 평균임금 하한", value: "최저임금 × 100/70" },
          { label: "고령자 감액 시작", value: "61세부터" },
          { label: "중증요양상태등급 범위", value: "1~3급만 해당" },
        ]}
      />
    ),
    "after-2": (
      <WarningBox
        type="info"
        title="재요양 중 상병보상연금 전환 요건"
      >
        <p>재요양 중에도 요양 시작 후 2년이 경과하고 중증요양상태등급 1~3급이며 취업하지 못하는 3가지 요건을 동시에 충족하면 상병보상연금으로 전환돼요.</p>
      </WarningBox>
    ),
  },
  ...
  "산재-장해급여-장해등급-기준-판정": {
    "after-0": (
      <RangeTable
        title="복수 장해 등급 상향 기준"
        rowHeader="장해 조합"
        colHeaders={[
          { label: "등급 상향폭" },
        ]}
        rows={[
          { range: "5급 이상 2개 이상", values: ["3등급 상향"], highlight: true },
          { range: "8급 이상 2개 이상", values: ["2등급 상향"] },
          { range: "13급 이상 2개 이상", values: ["1등급 상향"] },
        ]}
      />
    ),
    "after-2": (
      <StatCard
        items={[
          { label: "장해등급 범위", value: "1급~14급", sub: "1급이 가장 심함" },
          { label: "판정 시기", value: "요양 종결 시", sub: "증상 고정 상태에서 판정" },
          { label: "증상 미고정 시", value: "6개월 이내 고정 가능하면 대기" },
        ]}
      />
    ),
  },
  ...
  "산재-장해급여-지급액-연금-일시금-선택": {
    "after-0": (
      <RangeTable
        ...
        rows={[
          { range: "1급", values: ["329일분", "1,474일분"], highlight: true },
          { range: "2급", values: ["291일분", "1,309일분"] },
          { range: "3급", values: ["257일분", "1,155일분"] },
          { range: "4급", values: ["224일분", "1,012일분"] },
          { range: "5급", values: ["193일분", "869일분"] },
          { range: "6급", values: ["164일분", "737일분"] },
          { range: "7급", values: ["138일분", "616일분"] },
          { range: "8급", values: ["—", "495일분"] },
          { range: "9급", values: ["—", "385일분"] },
          { range: "10급", values: ["—", "297일분"] },
          { range: "11급", values: ["—", "220일분"] },
          { range: "12급", values: ["—", "154일분"] },
          { range: "13급", values: ["—", "99일분"] },
          { range: "14급", values: ["—", "55일분"] },
        ]}
      />
    ),
    "after-2": (
      <ComparisonTable
        ...
        rows={[
          { label: "1~3급", values: ["1~3급", "연금만 지급"] },
          { label: "4~7급", values: ["4~7급", "연금 또는 일시금 선택"] },
          { label: "8~14급", values: ["8~14급", "일시금만 지급"] },
        ]}
      />
    ),
  },
  ...
  "산재-장해급여-청구-방법-소멸시효": {
    "after-0": (
      <ProcessTimeline
        steps={[
          { step: "1", title: "장해급여청구서 제출", desc: "장해진단서·방사선 검사자료 등 첨부하여 근로복지공단에 제출" },
          { step: "2", title: "장해등급 판정", desc: "공단 전문의가 신체 부위별 장해등급 판정" },
          { step: "3", title: "지급 결정", desc: "연금 또는 일시금 결정 및 지급" },
          { step: "4", title: "재판정 (해당 시)", desc: "결정일로부터 2년 경과 후 1년 이내 실시" },
        ]}
      />
    ),
    "after-2": (
      <DateCalculator
        title="장해급여 소멸시효 계산"
        presets={[
          { label: "소멸시효 5년", days: 1825, description: "상병이 치유된 날의 다음 날부터 5년" },
        ]}
        description="장해급여 청구권은 치유일 다음 날부터 5년이에요. 다른 급여(3년)보다 기간이 길어요."
      />
    ),
  },
  ...
  "산재-유족급여-지급요건-수급자격-순위": {
    "after-0": (
      <RangeTable
        ...
        rows={[
          { range: "1순위", values: ["배우자", "재혼하지 않은 사실혼 포함"], highlight: true },
          { range: "2순위", values: ["자녀", "25세 미만 또는 장해등급 해당"] },
          { range: "3순위", values: ["부모", "60세 이상 또는 장해등급 해당"] },
          { range: "4순위", values: ["손자녀", "25세 미만 또는 장해등급 해당"] },
          { range: "5순위", values: ["조부모", "60세 이상 또는 장해등급 해당"] },
          { range: "6순위", values: ["형제자매", "19세 미만 또는 60세 이상"] },
        ]}
      />
    ),
    "after-2": (
      <WarningBox
        type="warning"
        title="수급자격 상실 사유에 유의하세요"
      >
        <p>배우자 재혼, 자녀 25세 도달, 형제자매 19세 도달(또는 60세 미만), 국적 상실 등으로 수급자격이 상실돼요. 상실 시 다음 순위자에게 수급권이 이전돼요.</p>
      </WarningBox>
    ),
  },
  ...
  "산재-유족보상연금-금액-청구-소멸시효": {
    "after-0": (
      <StatCard
        items={[
          { label: "기본 금액", value: "평균임금 47%", sub: "연간 기본금" },
          { label: "가산 금액", value: "수급자 1인당 5%", sub: "최대 20% (4명 이상)" },
          { label: "일시금 (연금 미해당 시)", value: "평균임금 1,300일분" },
          { label: "소멸시효", value: "5년", sub: "사망한 다음 날부터" },
        ]}
      />
    ),
    "after-2": (
      <RangeTable
        ...
        rows={[
          { range: "기본 산정", values: ["평균임금 120일분"] },
          { range: "최저 금액", values: ["1,394만원"] },
          { range: "최고 금액", values: ["1,927만원"] },
        ]}
      />
    ),
  },
  ...
  "산재-진폐-보험급여-특례-진폐보상연금-진폐유족연금": {
    "after-0": (
      <ComparisonTable
        title="일반 산재 급여 vs 진폐 특례 급여"
        columns={[
          { name: "일반 산재" },
          { name: "진폐 특례", highlight: true },
        ]}
        rows={[
          { label: "소득 보전 급여", values: ["휴업급여·상병보상연금", "진폐보상연금"] },
          { label: "요양 여부와 관계", values: ["요양 중에만 지급", "요양 여부와 무관"] },
          { label: "유족 급여", values: ["유족보상연금·일시금", "진폐유족연금"] },
          { label: "재청구 간격", values: ["해당 없음", "1년 경과 후"] },
        ]}
      />
    ),
    "after-2": (
      <StatCard
        items={[
          { label: "진폐 특례 급여 종류", value: "6가지" },
          { label: "진폐보상연금 구성", value: "진폐장해연금 + 기초연금" },
          { label: "응급 합병증 재청구", value: "1년 미만 가능" },
        ]}
      />
    ),
  },
  ...
  "산재-직업재활급여-직업훈련비용-직장복귀지원금-신청": {
    "after-1": (
      <ComparisonTable
        ...
        rows={[
          { label: "급여 종류", values: ["직업훈련비용·직업훈련수당", "직장복귀지원금·직장적응훈련비·재활운동비"] },
          { label: "대상 등급", values: ["1~12급", "해당 근로자 고용 사업주"] },
          { label: "신청처", values: ["근로복지공단", "근로복지공단"] },
        ]}
      />
    ),
    "after-2": (
      <WarningBox
        type="info"
        title="13~14급은 직업재활급여 대상이 아니에요"
      >
        <p>직업재활급여는 장해등급 1~12급 판정을 받은 근로자만 신청할 수 있어요. 13~14급은 경미한 장해로 분류되어 직업재활급여 대상에서 제외돼요.</p>
      </WarningBox>
    ),
  },
  ...
  "산재보험-보험급여-산정기준-평균임금-일용근로자-특례": {
    "after-0": (
      <StatCard
        items={[
          { label: "평균임금 산정 기간", value: "재해 전 3개월" },
          { label: "일용근로자 통상근로계수", value: "73/100", sub: "일당 × 73/100 = 평균임금" },
          { label: "3개월 이상 연속 고용 시", value: "일반 근로자 기준 적용" },
        ]}
      />
    ),
    "after-2": (
      <WarningBox
        type="info"
        title="평균임금이 통상임금보다 낮을 때"
      >
        <p>산정된 평균임금이 통상임금보다 낮으면 통상임금을 평균임금으로 적용해요. 최저임금보다 낮은 경우에도 최저임금을 기준으로 보험급여를 산정해요.</p>
      </WarningBox>
    ),
  },
  ...
  "산재보험-결정-불복-심사청구-재심사청구-절차": {
    "after-0": (
      <ProcessTimeline
        steps={[
          { step: "1", title: "심사청구", desc: "결정을 안 날부터 90일 이내, 근로복지공단에 제출" },
          { step: "2", title: "심사 결정", desc: "60일 이내 결정 (1회 20일 연장 가능)" },
          { step: "3", title: "재심사청구", desc: "심사 결정에 불복 시 산업재해보상보험재심사위원회에 청구" },
          { step: "4", title: "행정소송", desc: "재심사 결정에도 불복 시 법원에 행정소송 제기" },
        ]}
      />
    ),
    "after-2": (
      <WarningBox
        type="warning"
        title="행정심판은 제기할 수 없어요"
      >
        <p>산재보험 결정에 대해서는 행정심판을 제기할 수 없어요. 심사청구 → 재심사청구 → 행정소송 순서로만 불복할 수 있어요. 다만 업무상질병판정위원회 심의를 거친 건은 심사청구를 생략하고 바로 재심사청구를 할 수 있어요.</p>
      </WarningBox>
    ),
  },
  ...
  "산재보험-근로기준법-재해보상-면제-민사손해배상-청구": {
    "after-0": (
      <ComparisonTable
        title="산재보험 급여 vs 민사 손해배상"
        columns={[
          { name: "산재보험 급여" },
          { name: "민사 손해배상" },
        ]}
        rows={[
          { label: "요건", values: ["업무상 재해 인정", "사업주 고의·과실 입증"] },
          { label: "과실 상계", values: ["없음 (무과실 보상)", "피해자 과실 비율만큼 감액"] },
          { label: "위자료", values: ["불포함", "포함 가능"] },
          { label: "청구 절차", values: ["근로복지공단 신청", "법원 민사소송"] },
          { label: "관계", values: ["먼저 수령 → 차액만 민사 청구", "산재급여 수령액 공제"] },
        ]}
      />
    ),
    "after-2": (
      <WarningBox
        ...
        title="가장 유리한 청구 전략"
      >
        <p>산재보험 급여를 먼저 청구한 뒤, 사업주의 고의·과실이 있다면 차액분을 민사 손해배상으로 청구하는 것이 가장 유리해요. 미가입 사업장은 공단이 급여를 먼저 지급한 뒤 사업주에게 구상권을 행사해요.</p>
      </WarningBox>
    ),
  },
    ...
    "after-0": (
      <DecisionTree
        ...
        nodes={[
          {
            id: "start",
            question: "업무 수행 중 또는 업무와 관련하여 재해가 발생했나요?",
            options: [
              { label: "예, 업무 관련이에요", nextId: "type" },
              { label: "아니요, 업무와 무관해요", resultTitle: "업무상 재해 미해당", resultDesc: "업무와 재해 사이에 상당인과관계가 없으면 업무상 재해로 인정되지 않아요." },
            ],
          },
          {
            id: "type",
            question: "어떤 유형의 재해인가요?",
            options: [
              { label: "사고 (부상·사망)", nextId: "accident" },
              { label: "질병", nextId: "disease" },
              { label: "출퇴근 중 사고", nextId: "commute" },
            ],
          },
          {
            id: "accident",
            question: "사업주의 지배관리 하에서 발생했나요?",
            options: [
              { label: "예, 사업장 내 또는 지시 업무 중", resultTitle: "업무상 사고로 인정 가능", resultDesc: "업무시간 중 사업주 지배관리 하의 장소에서 업무 관련 행위 중 발생한 사고는 업무상 재해로 인정돼요." },
              { label: "아니요, 사적 행위 중", resultTitle: "업무상 재해 미해당 가능성", resultDesc: "사적 행위로 인한 사고는 원칙적으로 업무상 재해로 인정되지 않아요." },
            ],
          },
          {
            id: "disease",
            question: "업무상 유해요인에 노출된 경력이 있나요?",
            options: [
              { label: "예, 유해요인 노출 이력 있음", resultTitle: "업무상 질병 인정 가능", resultDesc: "업무상 유해요인에 노출되어 발생한 질병은 업무상 재해로 인정돼요. 의학적 인과관계 추단이 가능하면 돼요." },
              { label: "노출 이력 불분명", resultTitle: "종합 판단 필요", resultDesc: "입증책임은 근로자·유족에게 있어요. 의학적으로 완벽한 증명이 아니라 상당성이 추단되면 인정 가능해요." },
            ],
          },
          {
            id: "commute",
            question: "통상적인 경로와 방법으로 출퇴근했나요?",
            options: [
              { label: "예, 통상 경로·방법", resultTitle: "출퇴근 재해로 인정 가능", resultDesc: "사업주 제공 교통수단 또는 통상 경로·방법으로 출퇴근 중 발생한 사고는 업무상 재해예요." },
              { label: "아니요, 경로를 이탈했어요", resultTitle: "원칙적 미인정", resultDesc: "경로 일탈·중단 시 원칙적으로 미인정이지만 생필품 구입, 병원 진료 등 일상생활에 필요한 행위는 예외로 인정돼요." },
            ],
          },
        ]}
      />
  ...
  "사업장-사고-업무상-재해-인정기준-출퇴근-재해-행사-중": {
    "after-0": (
      <ComparisonTable
        title="사업장 내 사고·출퇴근 재해·행사 중 사고 비교"
        columns={[
          { name: "사업장 내 사고" },
          { name: "출퇴근 재해" },
          { name: "행사 중 사고" },
        ...
        rows={[
          { label: "인정 기준", values: ["사업주 지배관리 하 업무 관련 행위", "통상 경로·방법 또는 사업주 제공 교통수단", "사업주 시간 인정·지시·승인 또는 통상적 관례"] },
          { label: "휴게시간", values: ["사업주 지배관리 하 행위면 인정", "해당 없음", "해당 없음"] },
          { label: "예외 사유", values: ["사적 행위·자해 시 미인정", "경로 일탈·중단 시 원칙 미인정", "개인 부주의 제외 가능"] },
        ]}
      />
    ),
    "after-2": (
      <WarningBox
        type="info"
        title="경로 일탈이 허용되는 경우"
      >
        <p>생필품 구입, 의료기관 진료, 자녀 등하원, 선거 투표 등 일상생활에 필요한 행위로 경로를 잠시 벗어난 경우에는 출퇴근 재해로 인정될 수 있어요.</p>
      </WarningBox>
    ),
  },
  ...
  "업무상-질병-인정기준-뇌혈관-심장질환-과로-산재": {
    "after-1": (
      <RangeTable
        ...
        rows={[
          { range: "발병 전 12주", values: ["주 60시간 초과", "관련성 강함"], highlight: true },
          { range: "발병 전 12주", values: ["주 52~60시간", "시간에 비례하여 증가"] },
          { range: "발병 전 4주 평균", values: ["주 64시간 초과", "관련성 강함"] },
          { range: "발병 전 1주", values: ["12주 평균 대비 30%↑", "급성 과로 인정"] },
        ]}
      />
    ),
    "after-2": (
      <WarningBox
        ...
        title="야간근무는 30% 가산돼요"
      >
        <p>야간근무(22시~06시) 시간은 주간 근무시간에 30%를 가산하여 계산해요. 3개월 이상의 만성 과로도 업무상 질병으로 인정될 수 있으며, 기초질환이 있더라도 업무가 악화에 기여했으면 인정 가능해요.</p>
      </WarningBox>
    ),
  },
  ...
  "산재보험-가입-방법-당연가입-임의가입-신고절차": {
    "after-0": (
      <ComparisonTable
        title="당연가입 vs 임의가입"
        columns={[
          { name: "당연가입", highlight: true },
          { name: "임의가입" },
        ]}
        rows={[
          { label: "대상", values: ["근로자 1명 이상 모든 사업", "적용 제외 사업 중 희망자"] },
          { label: "효력 발생", values: ["근로자 고용 시 자동 성립", "공단 승인 다음 날"] },
          { label: "신고 기한", values: ["성립일로부터 14일 이내", "승인 신청 필요"] },
          { label: "보험료 부담", values: ["사업주 전액", "사업주 전액"] },
        ]}
      />
    ),
    "after-2": (
      <WarningBox
        type="warning"
        title="미신고 시 사업주에게 구상권이 행사돼요"
      >
        <p>산재보험에 가입하지 않은 사업장에서 재해가 발생하면 공단이 근로자에게 급여를 먼저 지급한 뒤 사업주에게 비용을 전액 구상해요. 소멸신고도 폐업일로부터 14일 이내에 해야 해요.</p>
      </WarningBox>
    ),
  },

  // ── 근로노동: Article 27 ──
  "산재보험-일괄적용-도급사업-건설업-사업주": {
    "after-0": (
      <ComparisonTable
        title="당연 일괄적용 vs 임의 일괄적용 비교"
        columns={[
          { name: "당연 일괄적용" },
          { name: "임의 일괄적용" },
        ]}
        rows={[
          { label: "대상", values: ["건설업 (한국표준산업분류 대분류)", "건설업 외 동일 사업종류"] },
          { label: "요건", values: ["동일 사업주 + 기간 정해진 사업", "동일 사업주 + 사업종류 같음"] },
          { label: "효력 발생", values: ["법률상 자동 적용", "승인신청서 접수 다음 날"] },
          { label: "해지", values: ["사업 폐지·종료 시 자동 소멸", "다음 보험연도 개시 7일 전까지 해지 신청"] },
          { label: "신고 기한", values: ["사업 시작일로부터 14일 이내", "근로복지공단 승인 필요"] },
        ]}
      />
    ),
    "after-2": (
  ...
  // ── 근로노동: Article 28 ──
  "산재보험료-징수-보험료율-개별실적요율-산정": {
    "after-0": (
      <StatCard
        items={[
          { label: "보험료 산정 공식", value: "보수총액 × 보험료율" },
          { label: "건설업·벌목업 신고 기한", value: "매년 3월 31일" },
          { label: "개별실적요율 조정폭", value: "±20%" },
          { label: "산재예방요율 인하폭", value: "최대 30%" },
        ]}
      />
    ),
    "after-2": (
      <ComparisonTable
        title="개별실적요율 보험수지율 구간별 조정"
        columns={[
          { name: "보험수지율" },
          { name: "보험료율 조정" },
        ]}
        rows={[
          { label: "5% 이하", values: ["5% 이하", "20% 인하"] },
          { label: "5% 초과 ~ 75% 이하", values: ["5%~75%", "비율에 따라 인하"] },
          { label: "75% 초과 ~ 85% 이하", values: ["75%~85%", "조정 없음"] },
          { label: "85% 초과 ~ 160% 이하", values: ["85%~160%", "비율에 따라 인상"] },
          { label: "160% 초과", values: ["160% 초과", "20% 인상"] },
        ]}
      />
    ),
  },
  ...
  // ── 근로노동: Article 29 ──
  "산재보험-국외사업-해외파견자-특례-가입": {
    "after-1": (
      <WarningBox
        type="warning"
        title="해외파견자 산재보험은 별도 가입이 필요해요"
      >
        <p>국내 사업장 출장자와 달리, 해외파견자는 사업주가 별도로 가입 신청해야 해요. 국외근로자 공급사업에 해당하면 가입 승인을 받을 수 없어요. 파견자 명단·기간·업무 등 변경 시 변경신고서를 제출해야 해요.</p>
      </WarningBox>
    ),
  },

  // ── 근로노동: Article 30 ──
  "산재보험-현장실습생-중소기업-사업주-특례": {
    "after-0": (
      <StatCard
        items={[
          { label: "현장실습생 보험급여", value: "8종류" },
          { label: "중소기업 사업주 가입 요건", value: "300명 미만" },
          { label: "가족종사자 범위", value: "배우자·4촌 이내" },
        ]}
      />
    ),
    "after-3": (
      <WarningBox
        type="warning"
        title="보험료 체납 시 보험급여가 제한돼요"
      >
        <p>체납 기간 중 발생한 업무상 재해에 대해 보험급여가 지급되지 않아요. 납부기일 속하는 달의 다음다음 달 10일까지 납부하면 급여 수급이 가능해요. 보험료 납부 상태를 주기적으로 확인하세요.</p>
      </WarningBox>
    ),
  },

  // ── 근로노동: Article 31 ──
  "산재보험-자활급여-수급자-노무제공자-특례": {
    "after-1": (
      <StatCard
        items={[
          { label: "노무제공자 직종 수", value: "18개 직종" },
          { label: "보험료 분담", value: "사업주 50% + 노무제공자 50%" },
          { label: "최저 휴업급여 보장액", value: "1일 41,150원" },
        ]}
      />
    ),
  },
  ...
  // ── 근로노동: Article 32 ──
  "산재-근골격계질병-인정기준-반복동작-업무상질병": {
    "after-0": (
      <ComparisonTable
        title="근골격계 질병 부위별 대표 질병"
        columns={[
          { name: "부위" },
          { name: "대표 질병" },
        ]}
        rows={[
          { label: "팔(상지)", values: ["목~손가락", "경추염좌, 회전근개건염, 수근관증후군"] },
          { label: "다리(하지)", values: ["둔부~발가락", "반월상 연골손상, 발바닥 근막염"] },
          { label: "허리", values: ["요추·주변 조직", "요부염좌, 요추간판탈출증"] },
        ]}
      />
    ),
    "after-1": (
  ...
  // ── 근로노동: Article 33 ──
  "산재-호흡기-신경정신-림프조혈기-질병-인정기준": {
    "after-0": (
      <WarningBox
        type="info"
        title="호흡기계 업무상 질병 주요 유해물질"
      >
        <p>석면은 석면폐증, 목재·곡물 분진과 디이소시아네이트·크롬·니켈 등은 직업성 천식, 석탄·암석 분진과 카드뮴은 만성폐쇄성폐질환, 유기용제는 비염(업무 중단 후 3개월 이내)의 원인이 돼요.</p>
      </WarningBox>
    ),
    "after-1": (
      <WarningBox
        type="info"
        title="신경정신계 업무상 질병 주요 유형"
      >
        <p>유기용제 노출은 중추신경계장해·말초신경병증, 납·수은·망간 노출은 중추신경계장해·파킨슨증을 유발해요. 정신적 충격 사건은 외상후스트레스장애(PTSD), 고객 폭력·폭언은 적응장애·우울병 에피소드로 이어질 수 있어요.</p>
      </WarningBox>
    ),
  },

  // ── 근로노동: Article 34 ──
  "산재-피부-눈-귀-간-감염성-질병-인정기준": {
    "after-1": (
      <WarningBox
        type="info"
        title="소음성 난청 인정 요건"
      >
        <p>85dB(A) 이상 연속음에 3년 이상 노출되고, 한 귀의 청력손실이 40dB 이상이어야 해요. 고막·중이에 뚜렷한 손상이 없고, 저음역보다 고음역에서 청력장해가 커야 하며, 24시간 이상 소음작업을 중단한 후 검사해야 해요.</p>
      </WarningBox>
    ),
  },

  // ── 근로노동: Article 35 ──
  "산재-직업성암-화학적-물리적-요인-질병-인정기준": {
    "after-0": (
      <WarningBox
        type="info"
        title="직업성 암 주요 유해물질과 발생 암"
      >
        <p>석면(10년 이상 노출)은 폐암·후두암·악성중피종·난소암, 벤젠(0.5ppm 이상 6개월 이상)은 백혈병·다발성골수종을 유발해요. 6가 크롬·카드뮴·베릴륨은 폐암, 비소는 폐암·방광암·피부암, 전리방사선은 갑상선암·유방암·위암 등 다수의 암을 일으킬 수 있어요.</p>
      </WarningBox>
    ),
    "after-2": (
      <WarningBox
        type="info"
        title="물리적 요인 질병 주요 유형"
      >
        <p>고기압·저기압은 감압병(잠수병)·공기색전증, 진동은 레이노 현상·말초순환장해를 유발해요. 전리방사선은 급성 방사선증·백내장·조혈기 질병, 고열 환경은 일사병·열사병, 저온 환경은 저체온증의 원인이 돼요.</p>
      </WarningBox>
    ),
  },

  // ────────────────────────────────────────────────
  // 복지 카테고리 (국민건강보험 직장가입자)
  // ────────────────────────────────────────────────
  ...
  "국민건강보험-개념-특성-적용대상": {
    ...
    "after-1": (
      <DecisionTree
        title="나는 어떤 가입자 유형일까?"
        nodes={[
          { id: "start", question: "사업장(직장)에 다니고 있나요?", options: [{ label: "네", nextId: "직장" }, { label: "아니요", nextId: "지역체크" }] },
          { id: "직장", question: "직장가입자예요.", options: [{ label: "가족이 부양요건 충족?", nextId: "피부양" }] },
          { id: "피부양", question: "부양요건·소득·재산 요건을 모두 충족하면 피부양자로 등록할 수 있어요.", options: [] },
          { id: "지역체크", question: "의료급여 수급자인가요?", options: [{ label: "네", nextId: "의료급여" }, { label: "아니요", nextId: "지역" }] },
          { id: "의료급여", question: "건강보험 대신 의료급여를 받아요.", options: [] },
          { id: "지역", question: "지역가입자로 가입돼요.", options: [] },
        ]}
      />
    ),
  },
  ...
  "직장가입자-가입자격-취득-신고": {
    ...
    "after-2": (
      <WarningBox type="warning" title="자격취득 신고 기한을 꼭 지키세요">
        <p>사용자(사업주)는 직장가입자 자격취득일로부터 14일 이내에 공단에 신고해야 해요. 기한을 넘기면 과태료 부과 대상이 될 수 있어요.</p>
      </WarningBox>
    ),
  },
  ...
  "직장가입자-자격변동-상실-신고": {
    "after-0": (
      <ComparisonTable
        title="자격변동 vs 자격상실 비교"
        columns={[
          { name: "자격변동" },
          { name: "자격상실" },
        ]}
        rows={[
          { label: "의미", values: ["사업장 간 이동(전출입)", "직장가입자 자격 자체를 잃음"] },
          { label: "사유", values: ["전근·이직·사업장 변경", "퇴직·사망·국적상실·의료급여 수급"] },
          { label: "신고 기한", values: ["변동일부터 14일 이내", "상실일부터 14일 이내"] },
          { label: "신고 의무자", values: ["변동된 사업장의 사용자", "상실 전 사업장의 사용자"] },
        ]}
      />
    ),
    "after-2": (
      <WarningBox type="info" title="퇴직 후 자격 전환">
        <p>직장가입자가 퇴직하면 자격을 잃고 지역가입자로 전환돼요. 이때 임의계속가입 제도를 이용하면 최대 36개월 동안 직장가입자 자격을 유지할 수 있어요.</p>
      </WarningBox>
    ),
  },

  // ── 복지: Article 4 ──
  "임의계속가입-실업자-직장가입자-자격유지": {
    "after-0": (
      <StatCard
        items={[
    ...
    "after-2": (
      <WarningBox type="warning" title="임의계속가입 납부 주의">
        <p>임의계속가입 보험료를 내지 않으면 납부기한 다음 날 자격이 상실돼요. 보험료를 밀리지 않도록 주의하세요.</p>
      </WarningBox>
    ),
  },
  ...
  "건강보험증-발급-제출-부정수급-금지": {
    "after-1": (
      <WarningBox type="warning" title="건강보험 부정수급 처벌">
        <p>건강보험증을 다른 사람에게 빌려주거나 빌려서 부정하게 보험급여를 받으면 1년 이하 징역 또는 1천만원 이하 벌금에 처해져요. 공단은 부정수급액의 전부 또는 일부를 징수할 수 있어요.</p>
      </WarningBox>
    ),
    "after-2": (
      <ContactCard
        contacts={[
          {
            name: "국민건강보험공단",
            description: "건강보험증 발급·자격 확인·부정수급 신고",
            url: "https://www.nhis.or.kr",
            urlLabel: "공단 홈페이지 바로가기",
            phone: "1577-1000",
          },
        ]}
      />
  ...
  "요양급여-비급여-범위-요양기관": {
    "after-0": (
      <ComparisonTable
        title="요양급여 vs 비급여 비교"
        columns={[
          { name: "요양급여" },
          { name: "비급여" },
        ]}
        rows={[
          { label: "보험 적용", values: ["건강보험 적용 (공단 부담)", "전액 본인 부담"] },
          { label: "대상", values: ["진찰·검사·약제·수술·입원 등", "업무·일상생활에 지장 없는 질환, 미용 목적 등"] },
          { label: "예시", values: ["감기 진료, 수술, 입원 치료", "쌍꺼풀 수술, 치아미백, 건강증진 목적 예방접종 등"] },
          { label: "법적 근거", values: ["국민건강보험법 제41조", "국민건강보험법 제41조제4항"] },
        ]}
      />
    ),
    "after-2": (
  ...
  "본인일부부담금-부담률-상한액-납부": {
    ...
    "after-2": (
      <WarningBox type="info" title="본인부담상한제를 꼭 기억하세요">
        <p>매년 본인이 부담한 요양급여비가 소득 수준별 상한액을 넘으면 초과분을 공단이 돌려줘요. 별도 신청 없이 자동으로 환급되는 경우가 많지만, 일부는 공단에 직접 신청해야 할 수 있어요.</p>
      </WarningBox>
    ),
  },
  ...
  "요양비-현금급여-수급-신청방법": {
    "after-0": (
      <ProcessTimeline
        steps={[
          { step: "1", title: "요양기관 외 장소에서 진료", desc: "긴급하거나 부득이한 사유로 요양기관이 아닌 곳에서 진료를 받아요." },
          { step: "2", title: "진료비 전액 본인 부담", desc: "진료비를 먼저 전액 지불해요." },
          { step: "3", title: "요양비 지급 신청", desc: "공단에 요양비 지급 신청서와 증빙서류를 제출해요." },
          { step: "4", title: "공단 심사 후 지급", desc: "공단이 요양급여 기준에 따라 심사한 후 지급 여부를 결정해요." },
        ]}
      />
    ),
    "after-2": (
    ...
    "after-1": (
      <ContactCard
        contacts={[
          {
            name: "국민건강보험공단",
            description: "국민행복카드 신청·임신출산 진료비 문의",
            url: "https://www.nhis.or.kr",
            urlLabel: "공단 홈페이지 바로가기",
            phone: "1577-1000",
          },
  ...
  "장애인-보조기기-보험급여-지원기준": {
    "after-0": (
      <RangeTable
        title="보조기기 보험급여율 구간"
        description="장애인 보조기기 종류별 보험급여 지원 비율. 기준금액은 고시 상한액 이내이며, 본인부담금은 10%예요."
        rowHeader="보조기기 유형"
        colHeaders={[
          { label: "급여율" },
        ]}
        rows={[
          { range: "의지·보조기·휠체어·전동스쿠터 등", values: ["기준금액의 90%"] },
          { range: "보청기", values: ["기준금액의 90%"] },
          { range: "그 밖의 보조기기", values: ["기준금액의 90%"] },
        ]}
      />
    ),
    "after-2": (
      <ProcessTimeline
        steps={[
          { step: "1", title: "보조기기 처방전 발급", desc: "의사의 처방전을 받아요." },
          { step: "2", title: "등록업소에서 구입·수리", desc: "공단에 등록된 업소에서 보조기기를 구입하거나 수리해요." },
          { step: "3", title: "보험급여 신청", desc: "공단에 보험급여 지급을 신청해요." },
          { step: "4", title: "공단 심사 후 지급", desc: "공단이 적합 여부를 확인한 후 급여를 지급해요." },
        ]}
      />
    ),
  },
  ...
  "건강보험-건강검진-종류-대상-비용": {
    "after-0": (
      <ComparisonTable
        title="건강검진 종류별 대상 비교"
        columns={[
          { name: "대상" },
          { name: "주기" },
        ]}
        rows={[
          { label: "일반건강검진", values: ["직장가입자, 세대주, 40세 이상 지역가입자·피부양자", "2년에 1회 (비사무직 매년)"] },
          { label: "암검진", values: ["위암(40세↑), 간암(40세↑), 대장암(50세↑), 유방암(40세↑ 여성), 자궁경부암(20세↑ 여성), 폐암(54~74세 고위험자)", "종류별 상이"] },
          { label: "영유아건강검진", values: ["생후 14일~72개월 영유아", "월령별 검진 시기"] },
        ]}
      />
    ),
    "after-2": (
      <ContactCard
        contacts={[
          {
            name: "국민건강보험공단",
            description: "건강검진 대상 조회·검진기관 찾기",
            url: "https://www.nhis.or.kr",
            urlLabel: "공단 홈페이지 바로가기",
            phone: "1577-1000",
          },
  ...
  "건강보험급여-제한-지급정지-사유": {
    "after-0": (
      <ComparisonTable
        title="급여 제한 vs 지급 정지 비교"
        columns={[
          { name: "급여 제한" },
          { name: "지급 정지" },
        ]}
        rows={[
          { label: "의미", values: ["보험급여를 하지 않음", "일정 기간 급여를 중단"] },
          { label: "사유", values: ["고의·중과실, 보험료 체납", "국외 체류, 현역병, 교도소 수용"] },
          { label: "해제 조건", values: ["체납보험료 완납 등", "사유 소멸 시 자동 해제"] },
          { label: "예외", values: ["체납 6회 미만이면 제한 안 됨", "현역병·수용자는 요양급여 실시"] },
        ]}
      />
    ),
    "after-2": (
      <WarningBox type="warning" title="보험료 체납 시 급여 제한 주의">
        <p>보수 외 소득월액보험료를 1개월 이상 체납하면 급여가 제한될 수 있어요. 다만 총체납횟수가 6회 미만이면 제한되지 않으니, 체납 횟수를 반드시 확인하세요.</p>
      </WarningBox>
    ),
  },
  ...
  "건강보험료-경감-면제-사유-경감률": {
    "after-0": (
      <ComparisonTable
        title="보험료 경감·면제 사유별 경감률"
        columns={[
          { name: "경감 대상" },
          { name: "경감률" },
        ]}
        rows={[
          { label: "섬·벽지 거주", values: ["등록 세대원", "50%"] },
          { label: "휴직 (무보수)", values: ["휴직 근로자", "50% (납부유예 가능)"] },
          { label: "육아휴직", values: ["육아휴직자", "60%"] },
          { label: "현역병 등 복무", values: ["복무 중인 가입자", "면제"] },
          { label: "국외 체류", values: ["1개월 이상 국외 체류자", "면제 (신청 시)"] },
        ]}
      />
    ),
    "after-2": (
      <WarningBox type="info" title="경감·면제 신청은 자동이 아니에요">
        <p>보험료 경감이나 면제는 사용자가 공단에 신청해야 적용돼요. 해당 사유가 생기면 사업장 담당자에게 알려 신청을 요청하세요.</p>
      </WarningBox>
    ),
  },
  ...
  "건강보험료-납부-정산-부담-방법": {
    "after-0": (
      <ComparisonTable
        ...
        rows={[
          { label: "일반 근로자", values: ["50%", "50%", "-"] },
          { label: "공무원", values: ["50%", "50% (국가·지자체)", "-"] },
          { label: "사립학교 교직원 (교원 외)", values: ["50%", "50% (설립자)", "-"] },
          { label: "사립학교 교원", values: ["50%", "30% (설립자)", "20%"] },
        ]}
      />
    ),
    "after-2": (
      <WarningBox type="info" title="퇴직 시 보험료 정산">
        <p>퇴직하면 사용자가 재직 기간 보수월액보험료를 다시 산정해서 근로자와 정산해요. 초과 납부했으면 돌려받고, 부족하면 추가로 내야 해요.</p>
      </WarningBox>
    ),
  },
  ...
  "건강보험료-체납-연체금-독촉-처분": {
    "after-0": (
      <ComparisonTable
        title="연체금 1단계 vs 2단계 비교"
        columns={[
          { name: "1단계" },
          { name: "2단계" },
        ]}
        rows={[
          { label: "적용 시점", values: ["납부기한 다음 날부터", "독촉장 납부기한 다음 날부터"] },
          { label: "부과 방식", values: ["체납보험료의 일정 비율", "체납보험료의 추가 비율"] },
          { label: "최대 한도", values: ["체납보험료의 5%", "매 1일마다 일정액 (총 9% 한도)"] },
        ]}
      />
    ),
    "after-2": (
      <WarningBox type="warning" title="체납처분 전 반드시 납부하세요">
        <p>독촉장 납부기한까지 보험료를 내지 않으면 공단이 국세 체납처분 예에 따라 재산을 압류·매각할 수 있어요. 체납보험료 분할납부 신청도 가능하니 공단에 문의하세요.</p>
      </WarningBox>
    ),
  },
  ...
  "건강보험-이의신청-심판청구-방법": {
    "after-0": (
      <ProcessTimeline
        steps={[
          { step: "1", title: "처분 통지 수령", desc: "공단의 처분 결과를 통지받아요." },
          { step: "2", title: "이의신청 (90일 이내)", desc: "처분을 안 날부터 90일 이내, 처분이 있은 날부터 180일 이내에 공단에 이의신청해요." },
          { step: "3", title: "공단 결정 (60일 이내)", desc: "공단이 이의신청을 심리하여 60일 이내에 결정해요." },
          { step: "4", title: "심판청구 (90일 이내)", desc: "이의신청 결정에 불복하면 건강보험분쟁조정위원회에 심판청구해요." },
          { step: "5", title: "행정소송", desc: "심판청구 결정에도 불복하면 행정소송을 제기할 수 있어요." },
        ]}
      />
    ),
    "after-2": (
      <WarningBox type="warning" title="이의신청 기한을 놓치지 마세요">
        <p>이의신청은 처분을 안 날부터 90일 이내에 해야 해요. 기한이 지나면 이의신청을 할 수 없으니, 처분 통지를 받으면 빨리 검토하세요.</p>
      </WarningBox>
    ),
  },
  ...
  "개인파산-채무-한도는-얼마인가요": {
    "after-0": (
      <ComparisonTable
        title="개인파산 vs 개인회생 비교"
        columns={[{ name: "개인파산", highlight: true }, { name: "개인회생" }]}
        rows={[
          { label: "채무한도", values: ["제한 없음", "담보 15억 / 무담보 10억"] },
          { label: "변제방법", values: ["재산 청산", "3~5년 변제계획"] },
          { label: "소득 요건", values: ["없음", "계속적 수입 필요"] },
          { label: "효과", values: ["면책 시 전액 면제", "변제 후 잔여 면제"] },
        ]}
      />
    ),
    "after-3": (
      <ContactCard
        contacts={[
          {
            name: "대한법률구조공단",
            description: "무료 법률상담 및 소송대리 (월수입 260만원 이하)",
            phone: "132",
            hours: "평일 09:00~18:00",
            url: "https://www.klac.or.kr",
            urlLabel: "대한법률구조공단 홈페이지",
          },
          {
            name: "신용회복위원회",
            description: "개인워크아웃 등 채무조정 상담",
            phone: "1600-5500",
            url: "https://www.ccrs.or.kr",
            urlLabel: "신용회복위원회 홈페이지",
          },
        ]}
      />
    ),
  ...
  // ── 개인파산 통장 압류 해제 ──
  "개인파산-신청하면-채무가-얼마나-줄어드나요": {
    "after-2": (
      <WarningBox title="비면책채권 압류는 면책 후에도 유지돼요">
        <p>조세 체납에 의한 압류는 면책으로 해제되지 않아요. 벌금, 양육비 등 비면책채권도 마찬가지예요. 파산선고 전 이미 집행 완료된 금액은 돌려받기 어려워요.</p>
      </WarningBox>
    ),
  },

  // ── 개인파산 면책 안 되는 이유 ──
  "개인파산-면책이-안-되는-채무는-무엇인가요": {
    "after-0": (
      <WarningBox title="면책불허가 주의사항">
        <p>도박이나 사치가 빚의 주된 원인이면 면책이 거절될 수 있어요. 이전 면책 확정일부터 7년이 안 지났으면 재신청 불가해요. 채권자목록을 일부러 빠뜨리면 해당 빚은 면책이 안 돼요.</p>
      </WarningBox>
    ),
  },

  // ── APF 한도 (개인파산 비용) ──
  "APP-한도가-1500만원인-이유는-무엇인가요": {
    "after-0": (
      <StatCard
        items={[
          { label: "인지대", value: "2,000원", sub: "파산+면책 합산" },
          { label: "예납비용 상한", value: "500만원", sub: "동시폐지 시 소액" },
          { label: "공고비용", value: "무료", sub: "법원 홈페이지 게시" },
        ]}
      />
    ),
    "after-1": (
      <ContactCard
        contacts={[
          {
            name: "대한법률구조공단",
            description: "무료 변호사 소송대리 (월수입 260만원 이하)",
            phone: "132",
            hours: "평일 09:00~18:00",
            url: "https://www.klac.or.kr",
            urlLabel: "대한법률구조공단 홈페이지",
  ...
  "개인파산-변호사-비용은-얼마인가요": {
    "after-2": (
      <ComparisonTable
        title="무료 법률지원 비교"
        columns={[{ name: "법률구조제도", highlight: true }, { name: "소송구조제도" }]}
        rows={[
          { label: "기관", values: ["대한법률구조공단", "법원"] },
          { label: "지원", values: ["변호사 소송대리 무료", "소송비용 유예/면제"] },
          { label: "요건", values: ["월수입 260만원 이하", "소송비용 능력 부족"] },
          { label: "연락처", values: ["132", "관할 법원"] },
        ]}
      />
    ),
  },
