...
const VIZ_MAP: VizMap = {
  ...
  // ── Article 2: 재판상이혼 사유·증거·위자료 ──
  "재판상이혼-사유-부정행위-가정폭력": {
    "after-2": (
      <AccordionChecklist
        groups={[
          {
            title: "바람(부정행위) 증거 체크리스트",
            items: [
              "카카오톡·문자 대화 캡처 (애정 표현, 만남 약속 등)",
              "통화 기록 (밤늦게 자주 통화한 내역)",
              "사진이나 동영상 (호텔 출입, 데이트 장면 등)",
              "카드 사용 내역 (숙박비, 선물 구매 등)",
              "직접 본 사람의 진술서",
            ],
          },
          {
            ...
            items: [
              "병원 진단서 (다친 부위 진단서)",
              "다친 부위 사진 (멍, 상처, 피가 난 부위)",
              "경찰 신고 기록 (112 접수증, 출동 기록)",
              "보호명령 결정문 (법원 접근금지 명령)",
              "녹음 파일 (욕설, 협박 녹음)",
            ],
          },
    ...
    "after-3": (
      <WarningBox type="warning" title="위자료 청구 기한을 꼭 지키세요">
        이혼 원인을 알게 된 날로부터 3년 안에 청구해야 해요. 이혼할 때 같이 청구하는 게 가장 편해요.
      </WarningBox>
    ),
  },
