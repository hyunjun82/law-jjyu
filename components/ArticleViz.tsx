  ...
  "산재보험-국외사업-해외파견자-특례-가입": {
    "after-1": (
      <WarningBox
        ...
        items={[
          "국내 사업장 출장자와 달리, 해외파견자는 사업주가 별도로 가입 신청해야 해요",
          "국외근로자 공급사업에 해당하면 가입 승인을 받을 수 없어요",
          "파견자 명단·기간·업무 등 변경 시 변경신고서를 제출해야 해요",
        ]}
      />
    ),
  },
  ...
  "산재보험-현장실습생-중소기업-사업주-특례": {
    ...
    "after-3": (
      <WarningBox
        ...
        items={[
          "체납 기간 중 발생한 업무상 재해에 대해 보험급여가 지급되지 않아요",
          "납부기일 속하는 달의 다음다음 달 10일까지 납부하면 급여 수급 가능",
          "보험료 납부 상태를 주기적으로 확인하세요",
        ]}
      />
    ),
  },
  ...
  "산재-호흡기-신경정신-림프조혈기-질병-인정기준": {
    "after-0": (
      <WarningBox
        ...
        items={[
          "석면 → 석면폐증",
          "목재·곡물 분진, 디이소시아네이트, 크롬, 니켈 등 → 직업성 천식",
          "석탄·암석 분진, 카드뮴 → 만성폐쇄성폐질환",
          "유기용제 → 비염 (업무 중단 후 3개월 이내)",
        ]}
      />
    ),
    "after-1": (
      <WarningBox
        ...
        items={[
          "유기용제 노출 → 중추신경계장해, 말초신경병증",
          "납·수은·망간 노출 → 중추신경계장해, 파킨슨증",
          "정신적 충격 사건 → 외상후스트레스장애(PTSD)",
          "고객 폭력·폭언 → 적응장애, 우울병 에피소드",
        ]}
      />
    ),
  },
  ...
  "산재-피부-눈-귀-간-감염성-질병-인정기준": {
    "after-1": (
      <WarningBox
        ...
        title="소음성 난청 인정 요건"
        items={[
          "85dB(A) 이상 연속음에 3년 이상 노출",
          "한 귀의 청력손실이 40dB 이상",
          "고막·중이에 뚜렷한 손상 없을 것",
          "저음역보다 고음역에서 청력장해가 클 것",
          "24시간 이상 소음작업 중단 후 검사",
        ]}
      />
    ),
  },
  ...
  "산재-직업성암-화학적-물리적-요인-질병-인정기준": {
    "after-0": (
      <WarningBox
        ...
        items={[
          "석면 (10년 이상 노출) → 폐암, 후두암, 악성중피종, 난소암",
          "벤젠 (0.5ppm 이상, 6개월 이상) → 백혈병, 다발성골수종",
          "6가 크롬, 카드뮴, 베릴륨 → 폐암",
          "비소 → 폐암, 방광암, 피부암",
          "전리방사선 → 갑상선암, 유방암, 위암 등 다수",
        ]}
      />
    ),
    "after-2": (
      <WarningBox
        ...
        items={[
          "고기압·저기압 → 감압병(잠수병), 공기색전증",
          "진동 → 레이노 현상, 말초순환장해",
          "전리방사선 → 급성 방사선증, 백내장, 조혈기 질병",
          "고열 환경 → 일사병, 열사병",
          "저온 환경 → 저체온증",
        ]}
      />
