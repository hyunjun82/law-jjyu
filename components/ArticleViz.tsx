...
const VIZ_MAP: VizMap = {
  ...
  "요양비-현금급여-수급-신청방법": {
    "after-0": (
      <ProcessTimeline
        title="요양비 신청 절차"
        steps={[
          { title: "요양기관 외 장소에서 진료", description: "긴급하거나 부득이한 사유로 요양기관이 아닌 곳에서 진료를 받아요." },
          { title: "진료비 전액 본인 부담", description: "진료비를 먼저 전액 지불해요." },
          { title: "요양비 지급 신청", description: "공단에 요양비 지급 신청서와 증빙서류를 제출해요." },
          { title: "공단 심사 후 지급", description: "공단이 요양급여 기준에 따라 심사한 후 지급 여부를 결정해요." },
        ]}
      />
    ),
    "after-2": (
  ...
  "장애인-보조기기-보험급여-지원기준": {
    "after-0": (
      <RangeTable
        title="보조기기 보험급여율 구간"
        description="장애인 보조기기 종류별 보험급여 지원 비율"
        columns={["보조기기 유형", "급여율"]}
        rows={[
          ["의지·보조기·휠체어·전동스쿠터 등", "기준금액의 90%"],
          ["보청기", "기준금액의 90%"],
          ["그 밖의 보조기기", "기준금액의 90%"],
        ]}
        footnote="기준금액은 고시 상한액 이내이며, 본인부담금은 10%예요."
      />
    ),
    "after-2": (
      <ProcessTimeline
        title="보조기기 급여 신청 절차"
        steps={[
          { title: "보조기기 처방전 발급", description: "의사의 처방전을 받아요." },
          { title: "등록업소에서 구입·수리", description: "공단에 등록된 업소에서 보조기기를 구입하거나 수리해요." },
          { title: "보험급여 신청", description: "공단에 보험급여 지급을 신청해요." },
          { title: "공단 심사 후 지급", description: "공단이 적합 여부를 확인한 후 급여를 지급해요." },
        ]}
      />
    ),
  },
  ...
  "건강보험-이의신청-심판청구-방법": {
    "after-0": (
      <ProcessTimeline
        title="불복 절차 흐름"
        steps={[
          { title: "처분 통지 수령", description: "공단의 처분 결과를 통지받아요." },
          { title: "이의신청 (90일 이내)", description: "처분을 안 날부터 90일 이내, 처분이 있은 날부터 180일 이내에 공단에 이의신청해요." },
          { title: "공단 결정 (60일 이내)", description: "공단이 이의신청을 심리하여 60일 이내에 결정해요." },
          { title: "심판청구 (90일 이내)", description: "이의신청 결정에 불복하면 건강보험분쟁조정위원회에 심판청구해요." },
          { title: "행정소송", description: "심판청구 결정에도 불복하면 행정소송을 제기할 수 있어요." },
        ]}
      />
    ),
    "after-2": (
