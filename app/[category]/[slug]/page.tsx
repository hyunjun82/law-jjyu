...
const SECTION_ICONS: Record<string, { icon: React.ElementType; color: string }> = {
  ...
  숙려: { icon: Sparkles, color: "text-amber-500" },
  ...
  분할: { icon: Scale, color: "text-violet-500" },
  재산: { icon: Scale, color: "text-violet-500" },
  위자료: { icon: Scale, color: "text-violet-500" },
  양육: { icon: HelpCircle, color: "text-blue-500" },
  면접교섭: { icon: HelpCircle, color: "text-blue-500" },
...
export async function generateMetadata({
  ...
  return {
    ...
    authors: [{ name: "생활법령 에디터", url: "https://law.jjyu.co.kr/about" }],
    openGraph: {
      title: article.title,
      description: article.metaDescription,
      url: `https://law.jjyu.co.kr/${catSlug}/${spokeSlug}`,
      type: "article",
      publishedTime: article.datePublished,
      modifiedTime: article.dateModified,
      authors: ["https://law.jjyu.co.kr/about"],
      siteName: "생활법령",
      locale: "ko_KR",
    },
    twitter: {
        ...
        <div className="mx-auto max-w-3xl px-4 py-12">
          ...
          <div className="mt-3 flex items-center gap-3 text-sm text-gray-400">
            ...
            {article.datePublished && (
              <>
                <span>|</span>
                <time dateTime={article.datePublished} className="daum-wm-datetime">
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            author: {
              "@type": "Person",
              name: "생활법령 에디터",
              url: "https://law.jjyu.co.kr/about",
              jobTitle: "법률 정보 전문 에디터",
              worksFor: {
                "@type": "Organization",
                name: "생활법령",
              },
            ...
            publisher: {
              "@type": "Organization",
              name: "생활법령",
              url: "https://law.jjyu.co.kr",
              logo: {
                "@type": "ImageObject",
                url: "https://law.jjyu.co.kr/logo.png",
              },
            },
            mainEntityOfPage: {
              "@type": "WebPage",
              "@id": `https://law.jjyu.co.kr/${catSlug}/${spokeSlug}`,
            },
            inLanguage: "ko",
          }),
        }}
            ...
            itemListElement: [
              {
                ...
                position: 1,
                name: "홈",
                item: "https://law.jjyu.co.kr",
              },
              {
                "@type": "ListItem",
                position: 2,
                name: catInfo.name,
                item: `https://law.jjyu.co.kr/${catSlug}`,
              },
              {
                "@type": "ListItem",
                position: 3,
                name: article.h1,
                item: `https://law.jjyu.co.kr/${catSlug}/${spokeSlug}`,
              },
            ],
          }),
        }}
